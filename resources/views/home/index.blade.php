...
<title>Alula 1 - Responsive Opencart Theme</title>
...
<ul class="ul-account list-unstyled">
<li>
<a id="a-register-link" href="{{URL::to('register')}}">Register</a>
</li>
<li>
<a id="a-login-link" href="{{URL::to('login')}}">Login</a>
</li>
</ul>
</div>
</div>
...
<img src="tt_alula/catalog/language/en-gb/en-gb.png" alt="English" title="English" />
en-gb
...
<div class="{{asset('tt_product_module occountdown_module countdown-style1 module-nav2')}}" id="product_module808">
...
<div class="item" data-countdown="Countdown51-1">
<div class="item-inner">
@foreach($product->images as $img)	
<div class="image images-container">
<a href="{{URL::to('productDetails/'.$product->productId)}}" class="product-image">
<img src="storage/app/public/{{$img->imageNameOne}}" style="width:150px;height:150px">
</a>				  
<div class="box-label">	
<div class="label-product label_sale"><span>-{{$product->salePercentage}}% </span></div>
</div>
<div class="action-links">
<?php
$total=($product->productQuantity) - ($product->productSold);
$count=App\Review::where('product_id' , $product->productId)->max('reviewRate');
$reviewCount=App\Review::where('product_id' , $product->productId)->count();
?>	
</div>
</div><!-- image -->
@endforeach
...
<p class="product-available">Availabe:<span>{{$product->productQuantity - $product->productSold}}</span></p>
<p class="product-sold">Sold:<span>{{$product->productSold}}</span></p>
<div class="bar-percent" >
<div class="available-percent" style="width:{{(($product->productQuantity - $product->productSold)*100) / $product->productQuantity}}%;"></div>
</div>
</div>
<p class="manufacture-product">
<span>Brands </span><a href="tt_alula/index-php_route_product/manufacturer/info_manufacturer_id_9.html">
{{App\Brand::where('brandId' , $product->brand_id)->first()->brandName}}</a>
</p>
<h4 class="product-name"><a href="tt_alula/index-php_route_product/product_product_id_51.html">{{$product->productName}}</a></h4>
<div class="ratings">
...
@if($userId)
<a href="{{URL::to('productDetails/'.$product->productId)}}">
<div>
...
<script >
$(document).ready(function () {
$('#Countdown51-1').countdown({
until: new Date(2020, 02-1, 11, 00, 00, 00),
labels: ['years', 'months ', 'weeks', 'days', 'hours', 'mins', 'secs'],
labels1: ['years', 'months ', 'weeks', 'days', 'hours', 'mins', 'secs'],
});
//$('#Countdown51-1').countdown('pause');
});
</script>
</div><!-- product-layout -->
</div>
...
<div class="inner"> 		
<a id="productNameDetailsTree" href="productName"><h1 class="product-name" id="productName"></h1></a>
<div class="ratings">
<div class="rating-box">
...
<a id="writeReviewRWQ" href="index.blade.php#tab-review">Write Review</a>
</div>	
...
$(document).on('click', '.show-modal', function() {
            ...
            $('#productDetailsInfo').attr('href','http://taibahvisitor.com/storeProject/productDetails/'+productId);
            $('#productNameDetailsTree').attr('href','http://taibahvisitor.com/storeProject/productDetails/'+productId);            
            $('#addFavourityAsd').attr('href','https://taibahvisitor.com/storeProject/addFavourity/'+userId+'/'+productId);
            $('#addCompareFsd').attr('href','http://taibahvisitor.com/storeProject/addCompare/'+userId+'/'+productId);
            $('#writeReviewRWQ').attr('href','http://taibahvisitor.com/storeProject/productDetails/'+productId); 
...
var product_owlCarousel = $("#product_module808 .tt-product");
...
$("#product_module808 .tt-product .owl-item").removeClass('last');
$("#product_module808 .tt-product .owl-item").removeClass('before-active');
$("#product_module808 .tt-product .owl-item.active:first").addClass('first');
$("#product_module808 .tt-product .owl-item.active:last").addClass('last');
$('#product_module808 .tt-product .owl-item.active:first').prev().addClass('before-active');
}
