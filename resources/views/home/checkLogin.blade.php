...
<li class="li-top-item left" style="float: left">
<a class="a-top-link" href="tt_alula/index-php_route_product/category_path_20.html">
<span>Shop</span>
...
<li><a href="index.php-route=account|login.html">Checkout Login</a></li>
</ul>
<div class="row">
...
<p>By login on website you will be able to Continue make order, be up to date on an order's status, and keep track of the orders you have previously made.</p>
...
<form action="{{url('showUser')}}" method="post" enctype="multipart/form-data">
	{{ csrf_field() }}
