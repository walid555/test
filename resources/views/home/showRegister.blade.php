...
<li><a href="index.php-route=account|register.html">Register</a></li>
</ul>
<div class="row" style="margin-top:20px">
<div id="content" class="col-sm-12">
<h1>Register Account</h1>
<p>If you already have an account with us, please login at the <a href="{{URL::to('showLogin')}}">login page</a>.</p>
<form action="{{url('saveRegister')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
{{ csrf_field() }}
<fieldset id="account">
...
<div class="col-sm-10">
<input type="text" name="userName" value="" placeholder="Your Name" id="input-firstname" class="form-control" required/>
<!-- Error First Name -->
...
<div class="col-sm-10">
<input type="email" name="emailRegist" value="" placeholder="E-Mail" id="input-register-email" class="form-control" required/>
<!-- Error Email -->
...
<select name="cityName" required>
 @foreach($cityData as $s_city)
  <option name="cityName"> {{ $s_city->cityName }} </option>
  @endforeach
  </select>
<!-- Error Phone -->
<div class="for-error error-telephone"></div>
...
<div class="col-sm-10">
<input type="password" name="passwordRegist" value="" placeholder="Password" id="input-register-password" class="form-control" required/>
<!-- Error Password -->
...
<div class="buttons">
<div class="pull-right">I have read and agree to the <a href="index.php-route=information%7Cinformation%7Cagree&information_id=3.html" class="agree"><b>Privacy Policy</b></a>
